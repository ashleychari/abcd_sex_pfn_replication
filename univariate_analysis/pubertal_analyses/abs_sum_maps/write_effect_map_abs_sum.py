...
if __name__ == "__main__":
    tests = os.listdir("/Users/ashfrana/Desktop/code/abcd_sex_pfn_replication/univariate_analysis/pubertal_analyses/puberty_analyses/discovery")
    #tests = ['hormone_ert_mf_age', 'pds_male_female_no_age', 'pds_male_female_age']
    for test in tests:
        disc_results_folder = f"/Users/ashfrana/Desktop/code/abcd_sex_pfn_replication/univariate_analysis/pubertal_analyses/puberty_analyses/discovery/{test}"
        rep_results_folder = f"/Users/ashfrana/Desktop/code/abcd_sex_pfn_replication/univariate_analysis/pubertal_analyses/puberty_analyses/replication/{test}"
