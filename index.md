...
### Part 9: Pubertal Analyses
  ...
  *NOTE: Make sure all of the results directories are created before running this script. (ie pds_male_female_no_age is a directory in the puberty_analyses_2/discovery directory); Also make sure to make your result directory and change the path in the gams R scripts* 
  ...
  3. Run [submit_scripts_oSex.py]() to run the analyses to look at the effect of sex on loadings controlled for by hormones and pds variables. This script calls [abcd_puberty_hormones_oSex.R]() and [abcd_puberty_stage_timing_gams_oSex.R]() depending on which dataset is being used.
