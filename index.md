...
### Part 9: Pubertal Analyses
  ...
  2. Run [submit_scripts.py](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/submit_scripts.py), which calls a corresponding shell script found in the `puberty_submit_scripts` folder that calls either [abcd_puberty_hormones.R](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/puberty_scripts/abcd_puberty_hormones.R), [abcd_puberty_stage_timing_gams.R](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/puberty_scripts/abcd_puberty_stage_timing_gams.R), and [abcd_puberty_stage_timing_gams_sex_specific.R](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/puberty_scripts/abcd_puberty_stage_timing_gams_sex_specific.R) depending on which dataset is used.
  *NOTE: Make sure all of the results directories are created before running this script. (ie pds_male_female_no_age is a directory in the puberty_analyses_2/discovery directory); Also make sure to make your result directory and change the path in the gams R scripts* 
  ...
  3. Run [submit_scripts_oSex.py](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/submit_scripts_oSex.py) to run the analyses to look at the effect of sex on loadings controlled for by hormones and pds variables. This script calls [abcd_puberty_hormones_oSex.R](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/puberty_scripts/abcd_puberty_hormones_oSex.R) and [abcd_puberty_stage_timing_gams_oSex.R](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/puberty_scripts/abcd_puberty_stage_timing_gams_oSex.R) depending on which dataset is being used.
  *NOTE: Make sure all of the results directories are created before running this script. (ie pds_male_female_oSex_no_age is a directory in the puberty_analyses_2/discovery directory); Also make sure to make your result directory and change the path in the gams R scripts*

  4. To create the absolute sum brain maps, use [write_effect_map_abs_sum.py](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/abs_sum_maps/write_effect_map_abs_sum.py) to get the absolute sum matrices. Once you have these, use the [cifti_wrapper.py](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/abs_sum_maps/cifti_wrapper.py) script to convert these matrices to a dscalar.nii format which can then be plotted in workbench.

  5. To create the barplots of the sex effect controlled for hormones/pds variables, use [make_barplot_mat.py](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/barplots/make_barplot_mats.py) to make the matrix for the barplot script and then run [create_barplot_wrapper.py](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/barplots/create_barplot_wrapper.py), which calls [create_barplots.R](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/barplots/create_barplots.R). Make sure you have a `barplots` directory and `matrices` directory created to store all the intermediate values and final results.

  6. To get the individual network maps, use [make_individual_mats.py](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/individual_network_maps/make_individual_mats.py) to get the fdr z vector for each of the 17 networks for each of the analyses done. Afterwards, run [to_cifti_wrapper.py](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/individual_network_maps/to_cifti_wrapper.py) that will convert the significant matrices to dscalar.nii format. To identify which networks are not all zero/are significant, use [identify_sig_networks.py](https://github.com/ashleychari/abcd_sex_pfn_replication/blob/main/univariate_analysis/pubertal_analyses/individual_network_maps/identify_sig_networks.py), which will create a `sig_networks.txt` file which contains an array of the significant networks. Using this information, you can then plot the specified networks in workbench for each of the tests.
