...
if __name__ == "__main__":
    ...
    metrics_table.to_csv("/cbica/projects/ash_pfn_sex_diff_abcd/results/multivariate_analysis/2foldcv_metrics_table.csv")
    ...
    for coef_fold in coefs_discovery:
        ...
        i += 1
    coefs_discovery_table.to_csv("/cbica/projects/ash_pfn_sex_diff_abcd/results/multivariate_analysis/2foldcv_discovery_coefs.csv")
    ...
    coefs_replication_table.to_csv("/cbica/projects/ash_pfn_sex_diff_abcd/results/multivariate_analysis/2foldcv_replication_coefs.csv")
