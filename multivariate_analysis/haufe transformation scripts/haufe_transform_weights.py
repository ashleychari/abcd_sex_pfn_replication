...
if __name__ == "__main__":
    ...
    haufe_transform(discovery_features_path, discovery_coefs_matrix_path, discovery_data_for_ridge_path, discovery_nonzero_indices, "discovery_haufe_transformed_one_run_weights.npy")
